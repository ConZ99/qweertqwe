...
#pragma warning restore 649
        ...
        public GameObject Handgun_01_Arms;
        public bool handgun = true;

        public GameObject Assault_Rifle_01_Arms;
        ...
        private void Start()
        {
            //Handgun_01_Arms = gameObject.transform.Find("Handgun_01_Arms").gameObject;
            //Assault_Rifle_01_Arms = gameObject.transform.Find("Assault_Rifle_01_Arms").gameObject;
        ...
        private void Update()
        {
            ...
            {
                arms = gameObject.transform.Find("Handgun_01_Arms");
                Handgun_01_Arms.SetActive(true);
                Assault_Rifle_01_Arms.SetActive(false);
            }
            if (Input.GetKeyUp(KeyCode.Alpha2))
            {
                arms = gameObject.transform.Find("Assault_Rifle_01_Arms");
                Handgun_01_Arms.SetActive(false);
                Assault_Rifle_01_Arms.SetActive(true);
            }
